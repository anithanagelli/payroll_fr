...
export const generatePayslipPDF = (payrollData) => {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["Take home pay", formatCurrency(netSalary)],
    ],
    theme: "grid",
    headStyles: { fillColor: [66, 139, 202] },
  })
